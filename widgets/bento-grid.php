...
class Elementor_Kami_K1_Bento_Grid_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'card_1_icon',
			[
				'label' => esc_html__( 'Custom Icon', 'kami-k1-elementor-addon' ),
		...
		$this->add_control(
			'card_1_col_span',
			[
				'label' => esc_html__( 'Column Span', 'kami-k1-elementor-addon' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'col-span-2',
				'options' => [
					'' => esc_html__( '1 Column', 'kami-k1-elementor-addon' ),
					'col-span-2' => esc_html__( '2 Columns', 'kami-k1-elementor-addon' ),
				],
			]
		);
			...
			<section id="specs" class="kami-k1-bento-section">
				...
				<div class="kami-k1-bento-container">
					...
					<div class="kami-k1-bento-grid">
						...
						<div class="kami-k1-bento-card <?php echo esc_attr( $settings['card_1_col_span'] ); ?>">
							...
							<div class="kami-k1-card-top with-title">
								<div>
									<span class="kami-k1-icon-container">
										<?php 
										if ( ! empty( $settings['card_1_icon']['value'] ) ) {
											\Elementor\Icons_Manager::render_icon( $settings['card_1_icon'], [ 'aria-hidden' => 'true' ] );
										} else {
											?>
						...
						<!-- Card 2: Speed (1 Col) -->
						<div class="kami-k1-bento-card <?php echo esc_attr( $settings['card_2_col_span'] ); ?>">
							<div class="kami-k1-card-glow-spot"></div>
							<div class="kami-k1-card-top">
								<span class="kami-k1-icon-container">
									<?php 
									if ( ! empty( $settings['card_2_icon']['value'] ) ) {
										\Elementor\Icons_Manager::render_icon( $settings['card_2_icon'], [ 'aria-hidden' => 'true' ] );
									} else {
										?>
										<svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
						...
						<div class="kami-k1-bento-card <?php echo esc_attr( $settings['card_3_col_span'] ); ?>">
							<div class="kami-k1-card-glow-spot"></div>
							<div class="kami-k1-card-top">
								<span class="kami-k1-icon-container">
									<?php 
									if ( ! empty( $settings['card_3_icon']['value'] ) ) {
										\Elementor\Icons_Manager::render_icon( $settings['card_3_icon'], [ 'aria-hidden' => 'true' ] );
									} else {
										?>
										<svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
						...
						<div class="kami-k1-bento-card <?php echo esc_attr( $settings['card_4_col_span'] ); ?>">
							<div class="kami-k1-card-glow-spot"></div>
							...
							<div class="kami-k1-card-top with-title">
								<div>
									<span class="kami-k1-icon-container">
										<?php 
										if ( ! empty( $settings['card_4_icon']['value'] ) ) {
											\Elementor\Icons_Manager::render_icon( $settings['card_4_icon'], [ 'aria-hidden' => 'true' ] );
										} else {
											?>
											<svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
						...
						<div class="kami-k1-bento-card <?php echo esc_attr( $settings['card_5_col_span'] ); ?>">
							<div class="kami-k1-card-glow-spot"></div>
							<div class="kami-k1-card-top">
								<span class="kami-k1-icon-container">
									<?php 
									if ( ! empty( $settings['card_5_icon']['value'] ) ) {
										\Elementor\Icons_Manager::render_icon( $settings['card_5_icon'], [ 'aria-hidden' => 'true' ] );
									} else {
										?>
										<svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
						...
						<div class="kami-k1-bento-card <?php echo esc_attr( $settings['card_6_col_span'] ); ?>">
							<div class="kami-k1-card-glow-spot"></div>
							<div class="kami-k1-card-top">
								<span class="kami-k1-icon-container">
									<?php 
									if ( ! empty( $settings['card_6_icon']['value'] ) ) {
										\Elementor\Icons_Manager::render_icon( $settings['card_6_icon'], [ 'aria-hidden' => 'true' ] );
									} else {
										?>
										<svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
						...
						<div class="kami-k1-bento-card <?php echo esc_attr( $settings['card_7_col_span'] ); ?>">
							<div class="kami-k1-card-glow-spot"></div>
							<div class="kami-k1-card-top">
								<span class="kami-k1-icon-container">
									<?php 
									if ( ! empty( $settings['card_7_icon']['value'] ) ) {
										\Elementor\Icons_Manager::render_icon( $settings['card_7_icon'], [ 'aria-hidden' => 'true' ] );
									} else {
										?>
										<svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
