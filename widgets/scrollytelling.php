...
class Elementor_Kami_K1_Scrollytelling_Widget extends \Elementor\Widget_Base {
	...
	protected function render() {
		...
		<?php /* =========================================================
		   FIXED CANVAS LAYER — position:fixed like original Next.js source
		   Covers the full viewport while user scrolls through 400vh spacer
		   ========================================================= */ ?>
		...
		<?php /* =========================================================
		   SCROLL SPACER — 400vh tall, creates the scroll room
		   The fixed canvas above "plays" as user scrolls through this
		   ========================================================= */ ?>
		<div id="scrollytelling" class="kami-k1-scrollytelling-container">
			<!-- This is intentionally empty — just provides scroll height -->
		</div>
