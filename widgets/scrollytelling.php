...
class Elementor_Kami_K1_Scrollytelling_Widget extends \Elementor\Widget_Base {
	...
	protected function render() {
		...
		<div class="kami-k1-addon-wrapper">
			...
			<div id="kami-k1-preloader" class="kami-k1-preloader screen-effect hud-grid-fine">
			...
			<div id="scrollytelling" class="kami-k1-scrollytelling-container">
				...
				<div class="kami-k1-sticky-viewport">
					
					<!-- 3D Canvas scrubbing -->
					<div class="kami-k1-canvas-wrapper">
					...
					<!-- Narrative card overlays -->
					<div class="kami-k1-narrative-overlay">
						<!-- Spacer to balance center placement -->
						...
						<div class="kami-k1-narrative-middle">
							...
							<div class="kami-k1-narrative-box split-layout">
								<div class="title-part">
									<h2>AXIAL<br/><span>EXPLOSION</span></h2>
								</div>
								<div class="desc-part">
									<p>AS THE CHASSIS EXPANDS, THE COMPONENT GRID DISSOLVES TO REVEAL PRECISION MECHANICAL LAYERS.</p>
								</div>
							</div>

							<!-- Node 4: Gasket mounting -->
							<div class="kami-k1-narrative-box centered-mono">
								<div>
							...
							<!-- Node 5: Tactile perfection -->
							<div class="kami-k1-narrative-box split-layout">
								<div class="title-part">
									<h2>TACTILE<br/><span>PERFECTION</span></h2>
								</div>
								<div class="desc-part">
									<p>KAILH 5-PIN HOT-SWAPPABLE SOCKETS ENGAGE GOLD-PLATED CONTACTS FOR MAX LIFESPAN.</p>
								</div>
							</div>
							...
							<div class="kami-k1-narrative-box split-layout">
								<div class="title-part">
									<h2>ENDLESS<br/><span>ENERGY</span></h2>
								</div>
								<div class="desc-part">
									<p>4000MAH POWER CELL DELIVERS CONTINUOUS WORKSTATION RUNTIME UP TO 200 HOURS.</p>
								</div>
							</div>
						...
						<!-- Persistent bottom mouse indicator helper -->
